...
# Use the Read Only Mysql endpoint to create backups
DBHOST="ro-mysql"
#Backup all Mysql Db's excluding below
DBNAMES="all"
...
DBEXCLUDE="information_schema  master  mysql  performance_schema  sys  tmp  {{ mysql_exclude }}"
...
BACKUPFILES=""
#Modified to use my.cnf file that is created for use with salt
OPT="--defaults-file=/root/.my.cnf --quote-names --opt"			# OPT string for use with mysqldump ( see man mysqldump )
